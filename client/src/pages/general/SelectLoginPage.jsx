  ...
  const LoginTypes = [
    {
      image: IconStudent,
      title: "Studente",
      description: "Login Studenti",
      link: "/login",
    },
    {
      image: IconTeacher,
      title: "Professori",
      description: "Login Docenti",
      link: "/login-teacher",
    },
    {
      image: IconUniversity,
      title: "Ateneo",
      description: "Login per accademie, atenei e scuole",
    ...
    <div className="flex justify-center p-5 bg-gradient-to-t from-greensea via-jade to-emerald min-h-screen tablet:p-8 items-center desktop:p-8">
      <div className="w-full flex justify-around flex-wrap p-8 gap-3 tablet:gap-10">
        {LoginTypes.map((data) => (
          <div
            key={nextId()}
            className="w-full tablet:w-2/5 desktop:w-1/3 desktop:h-1/2 desktop-l:w-1/5 desktop-4k:h-1/3 desktop-4k:w-1/4 desktop-4k:text-4xl flex items-center justify-center shadow-xl bg-white rounded-lg p-5 max-w-md mx-auto desktop-4k:max-w-6xl desktop-4k:rounded-2xl desktop-4k:p-12"
          >
